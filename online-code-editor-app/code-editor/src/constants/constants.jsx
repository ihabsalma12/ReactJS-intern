...
export const customStyles = {
    control: (styles) => ({
        ...
        justifyContent: "start", // Added justify-content start
        flexDirection: "row", // Added flex-direction row
        ":hover": {
            border: "2px solid #000000",
            boxShadow: "none",
        },
...
export const themes = [
    { id: 0, name: "hc-black", label: "High Contrast Black", value: "hc-black" },
    { id: 1, name: "vs-dark", label: "Visual Studio Dark", value: "vs-dark" },
    { id: 2, name: "light", label: "Light", value: "light" },
]
